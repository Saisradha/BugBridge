-- CreateEnum
CREATE TYPE "Role" AS ENUM ('REPORTER', 'SOLVER', 'BUSINESS', 'ADMIN');
...
-- AddForeignKey
ALTER TABLE "Solution" ADD CONSTRAINT "Solution_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "Report"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
